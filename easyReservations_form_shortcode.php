...
function reservations_form_shortcode($atts){
	...
	$popuptemplate.= '<input onclick="easyAddAnother();" type="button" value="'.__('Add another enquitu', 'easyReservations').'">';
	$popuptemplate.= '<input class="easy_overlay_submit"  type="button" onclick="easyFormSubmit(1);" value="'.__('Submit all enquiries', 'easyReservations').'">';
