			...
			echo easyreservations_generate_form('er_main_set', 'admin.php?page=reservation-settings', 'post', false, array('easy-set-main' => wp_create_nonce('easy-set-main')), $table);
			 do_action( 'er_set_main_out' ); ?>
				...
				<table class="<?php echo RESERVATIONS_STYLE; ?>" style="width:100%;margin-bottom:7px;" cellspacing="0" cellpadding="0" style="background:#fff;">
					...
					<tbody>
						<tr>
							<td style="font-weight:bold;padding:10px;text-align:center"><span style="width:20%;display: inline-block">Version: <?php echo RESERVATIONS_VERSION; ?></span><span style="width:30%;display: inline-block">Last update: 19.07.2016</span><span style="width:30%;display: inline-block">written by Feryaz Beer</span></td>
						</tr>
						<tr class="alternate">
